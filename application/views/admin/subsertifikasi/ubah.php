        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="<?php echo base_url() ?>subsertifikasi/simpan_perubahan">

                  <input type="hidden" name="id_subsertifikasi" value="<?php echo $id_sub_sertifikasi ?>">
                  ...
                  <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                      ...
                      <option value="n" <?php  if($status == "n"){echo "selected";} ?>>Non Aktif</option>
                    </select>
