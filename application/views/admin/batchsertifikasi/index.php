                   ...
                   foreach ($batch as $b) { ?>
                     <tr>
                       ...
                       <td>
                         ...
                         <a href="<?php echo base_url('input_nilai_sertifikasi/nilai_umum/' . $b->bs_id) ?>" class="btn btn-primary btn-sm mt-2">Input Nilai Peserta Umum</a>
                         <a href="<?php echo base_url('input_nilai_sertifikasi/nilai_mahasiswa/' . $b->bs_id) ?>" class="btn btn-primary btn-sm mt-2">Input Nilai Peserta Mahasiswa</a>
                         <a href="<?php echo base_url('Absen_sertifikasi/absen_pertemuan/' . $b->bs_id) ?>" class="btn btn-warning btn-sm mt-2">Lihat Pertemuan</a>
                       </td>
                     </tr>
                   <?php } ?>
                 </tbody>
